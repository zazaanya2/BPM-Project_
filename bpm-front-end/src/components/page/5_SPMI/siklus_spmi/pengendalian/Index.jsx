...
export default function Index({ onChangePage }) {
  const data = [
    {
      ...
      dok_nodok: "ND-9508",
      dok_ref: 1,
      dok_ref_name: "Hasil Audit Mutu Internal ",
      dok_rev: 0,
      dok_tahun: 2023,
    },
    {
      ...
      dok_nodok: "ND-2559",
      dok_ref: 7,
      dok_ref_name: "Perubahan sistem manajemen mutu",
      dok_rev: 0,
      dok_tahun: 2023,
    },
    {
      ...
      dok_ref: 6,
      dok_ref_name:
        "Status tindak lanjut dari hasil Tinjauan Manajemen  sebelumnya",
      dok_rev: 4,
      dok_tahun: 2024,
    },
    {
      ...
      dok_nodok: "ND-7816",
      dok_ref: 2,
      dok_ref_name: "Umpan balik dan hasil kepuasan",
      dok_rev: 1,
      dok_tahun: 2022,
    },
    {
      ...
      dok_nodok: "ND-1909",
      dok_ref: 4,
      dok_ref_name: "Pencapaian sasaran mutu/ indikator kinerja",
      dok_rev: 5,
      dok_tahun: 2022,
    },
    {
    ...
    },
    {
      ...
      dok_nodok: "ND-2803",
      dok_ref: 5,
      dok_ref_name: "Ketidaksesuaian dan tindakan perbaikan",
      dok_rev: 0,
      dok_tahun: 2021,
    },
    {
  ...
  const title = "Pengendalian";
  const breadcrumbs = [{ label: "Siklus SPMI" }, { label: "Pengendalian" }];
